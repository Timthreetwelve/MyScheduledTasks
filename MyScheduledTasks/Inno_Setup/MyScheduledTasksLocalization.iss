...
ko.NotSelfContained=이렇게 하면 %1 버전 %2.%n%n이 버전의 표준 버전이 설치됩니다. 이 버전은 .NET 8 데스크톱 런타임을 기존에 설치해야 하며 x64 및 x86 시스템과 모두 호환됩니다.%n%n계속하기 전에 다른 모든 응용 프로그램을 닫는 것이 좋습니다.%n%n계속하려면 '다음'을 클릭하거나 '취소'를 클릭하여 설치를 종료하는 것이 좋습니다.
